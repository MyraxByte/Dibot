exports.run = async (client, message, args) => {
    ...
    // Check inputs
    if (!reaction_channel || !reaction_message || !reaction_emoji || !reaction_role) return message.channel.send(`**Error**! Use: \`${Dibot.guildDB.prefix}rr-add\` \`#channel-name\` \`message_id\` \`:emoji_name:\` \`@role\``)
